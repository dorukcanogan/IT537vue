<template>
  <div id="app">
    ...
    <b-container class="bv-example-row">
      <b-row>
        <b-col>
          <h4 class="baslık">Eğlence Haberleri</h4>
        </b-col>
      </b-row>
...
export default {
  ...
  created() {
    const url = 'https://newsapi.org/v2/top-headlines?country=tr&category=entertainment&apiKey=098ba3055806413080e3a055f8e8c17b';
    fetch(url)
    .then((response) => {return response.json()})
    .then((response) => {
      this.topheadlines = response.articles;
